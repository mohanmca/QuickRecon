...
namespace QuickRecon
{
    ...
    public class CSVReader : IDisposable
    {
        ...
        public DataTable CreateDataTable(bool headerRow, string tableName)
        {
        ...
        public static DataTable ReadCSVFile(string filename, bool headerRow, int scanRows, string tableName)
        {
            using (CSVReader reader = new CSVReader(new FileInfo(filename)))
            {
                reader.ScanRows = scanRows;
                return reader.CreateDataTable(headerRow,tableName);
            }
        }
        ...
        /// <param name="headerRow">True if the first row contains column names</param>
        /// <returns>System.Data.DataTable object that contains the CSV data</returns>
        public static DataTable ReadCSVFile(string filename, bool headerRow, string tableName)
        {
            using (CSVReader reader = new CSVReader(new FileInfo(filename)))
                return reader.CreateDataTable(headerRow, tableName);
        }
